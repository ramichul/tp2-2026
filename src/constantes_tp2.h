...
#define MSJ_ALERTA_BATALLA "\033[38;5;%im       ¡SE INICIÓ UNA BATALLA!             \033[0m\n"
#define MSJ_UI_CONTRINCANTES_BATALLA "\033[38;5;%im%s\033[0m vs. \033[38;5;%im%s\033[0m\n\n"
#define MSJ_UI_PROPUESTA_ELECCION "¡Elige una opción!\n\n\033[38;5;%imPIEDRA (%c)\033[0m - \033[38;5;%imPAPEL (%c)\033[0m - \033[38;5;%imTIJERA (%c)\033[0m - \033[38;5;%imESCAPAR (%c)\033[0m\n"
...
#define MSJ_UI_RECORD_BATALLA "Batalla %s contra \033[38;5;%im%s\033[0m - Total de turnos: %zu\n"
#define MSJ_UI_RECORD_BATALLA_ESCAPADA "Escapó de \033[38;5;%im%s\033[0m - Total de turnos: %zu \n"
...
#define MSJ_REGLAS_ENCABEZADO "\033[38;5;%im    ____             __          \n   / __ \\___  ____ _/ /___ ______\n  / /_/ / _ \\/ __ `/ / __ `/ ___/\n / _, _/  __/ /_/ / / /_/ (__  ) \n/_/ |_|\\___/\\__, /_/\\__,_/____/  \n           /____/\033[0m\n"
#define ITEM_REGLA "\n\n\033[38;5;%im-\033[0m"
#define MSJ_REGLA_1 "%s se puede mover con las teclas '%c', '%c' o '%c' e inicia con un total de \033[38;5;%im%i\033[0m pasos. Cada movimiento resta un paso."
#define MSJ_REGLA_2 "Cada casilla del tablero puede estar vacía ( \033[38;5;%im%s\033[0m ), contener pasto común ( \033[38;5;%im%s\033[0m ) o pasto peligroso  ( \033[38;5;%im%s\033[0m )."
#define MSJ_REGLA_3 "Al pisar un casillero de pasto peligroso ( \033[38;5;%im%s\033[0m ), el jugador puede ser \033[38;5;%imatacado por un Pokémon\033[0m , iniciando una batalla."
#define MSJ_REGLA_4 "Al iniciarse una batalla pokemon, se presentará un juego de \033[38;5;%impiedra, papel o tijera\033[0m, con la opción de escapar de la batalla."
#define MSJ_REGLA_5 "Ganar una batalla agrega %i pasos al contador. Además se considerará capturado el Pokémon que haya atacado. En caso de empate se reiniciará la batalla y no cambiará el número de pasos. Si la batalla se pierde, se restarán %i pasos. Si se escapa de la batalla, se restarán %i pasos."
#define MSJ_REGLA_6 "En cualquier caso, luego de finalizar una batalla, el casillero en donde ocurrió \033[38;5;%imno podrá generar más batallas.\033[0m"
#define MSJ_REGLA_7 "El juego finaliza cuando se capturan todos los Pokémon objetivo o no quedan más pasos.\n\n"
